...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-25uci3k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-25uci3k.containers.anotherwebservice.com/
...
```
git clone git@github.com:Friendly213/container-25uci3k.git
cd container-25uci3k
```
...
```
docker attach container-25uci3k
```
